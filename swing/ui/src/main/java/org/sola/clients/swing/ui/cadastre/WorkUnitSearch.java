 ...
 * @author RizzoM
 */
public class WorkUnitSearch extends FreeTextSearch {

    private SolaTask searchTask = null;

    public WorkUnitSearch() {
        super();
...
//                            WSManager.getInstance().getCadastreService().getCadastreObjectByParts(searchString),
                            WSManager.getInstance().getCadastreService().getSpatialUnitGroupByHierarchy(searchString, 5),
